...
- (void)build
{
	...
	cells[1]=[self createBlockCellAtX:b.width/2 Y:1];
	cells[2]=[self createBlockCellAtX:b.width/2 Y:2];
	cells[3]=[self createBlockCellAtX:b.width/2-1 Y:2];
}
